...
public boolean isBallInLab(int rectCollision[]) {
...
public boolean isBallInSquare(int victorySquare[]) {
...
public boolean isMouseOverCircle() {
 ...
 if (    
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "labyrinth" };
    if (passedArgs != null) {
